...
function Entertainment() {
  ...
  const fetchNews = async (pageNumber) => {
    const newsUrl = `https://newsapi.org/v2/everything?q=Entertainment&language=en&sortBy=publishedAt&pageSize=6&page=${pageNumber}&apiKey=${API_KEY}`;
  ...
  return (
    <>
      ...
      <div className="politics-container">
        <h1>💼 Global Entertainment News</h1>
